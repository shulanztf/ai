 ...
 * http 工具类
 */
public class HttpUtilForHeWeather {

    public static String post(String requestUrl, String params)
            throws Exception {
        String contentType = "application/x-www-form-urlencoded";
        return HttpUtilForHeWeather.post(requestUrl, contentType, params);
    }
    ...
    public static String post(String requestUrl, String contentType, String params)
        ...
        return HttpUtilForHeWeather.post(requestUrl,contentType, params, encoding);
    }

    public static String post(String requestUrl,String contentType, String params, String encoding)
            throws Exception {
        String url = requestUrl;
        return HttpUtilForHeWeather.postGeneralUrl(url, contentType, params, encoding);
    }
